<section class="content">
  ...
  <div class="box box-info">
           ...
           <!-- /.box-header -->
           <!-- form start -->
           <form class="form-horizontal" action="<?php echo base_url('manage/cargoadd'); ?>" method="post" enctype="multipart/form-data">
             <div class="box-body">
               ...
               <div class="form-group">
                 ...
                 <div class="col-sm-10">
             <input  name="siteUrl"  type="file" class="form-control">
                 </div>
               </div>
            </div>
             <!-- /.box-body -->
