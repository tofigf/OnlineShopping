...
<title>UDEMY |Ən çox verilən suallar </title>
<meta property="og:url"           content="Ən çox verilən suallar" />
<meta property="og:type"          content="website" />
<meta property="og:title"         content="UDEMY |Ən çox verilən suallar " />
...
<div id="content" class="col-sm-9">
  <?php
$this->load->view('front/question/breadcrumb');
$this->load->view('front/question/main_content');
   ?>
</div>
</div>
</div>
