...
<?php $this->load->view('front/include/mobil_cat'); ?>
...
<?php  $this->load->view('front/include/users'); ?>

<?php $this->load->view('front/include/specials'); ?>

<?php $this->load->view('front/include/bestseller'); ?>
</aside>
<div id="content" class="col-sm-9">
<?php $this->load->view('front/include/galery'); ?>
