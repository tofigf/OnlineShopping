...
<a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>assets/front/image/logo.png" title="UDEMY | Codeigniter E-ticaret"  alt="UDEMY | Codeigniter E-ticaret" class="img-responsive"/></a>
</div>
</div>
<div class="col-sm-6 col-xs-6">
<div class="search">
<input type="text" name="term" id="arama" placeholder="Ürün Adını Yazınız.." />
<button type="button" class="button-search">Arama</button>
<div class="clear"></div>
</div>
</div>
<div class="col-sm-3">
...
<li>
<p class="text-center"><a href="#">Sepete Git</a></p>
</li>
</ul>
</div>
</div>
